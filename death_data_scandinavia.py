...
ax1.legend(loc=2)
ax1.set_title("Daily COVID-19 Deaths & Death Differences (Scandinavia)", pad=15)
...
#plt.savefig('death_data_scandinavia.png')
#plt.show()
fig.savefig('figures/death_data_scandinavia.png')